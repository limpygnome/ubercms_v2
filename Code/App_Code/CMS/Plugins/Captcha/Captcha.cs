...
namespace CMS
{
    namespace Plugins
    {
        public class Captcha : Plugin
        {
            ...
            public Captcha(int pluginid, string title, string directory, PluginState state, PluginHandlerInfo handlerInfo)
            ...
            {
                // Install settings
                Core.Settings.updateOrAdd(PluginID, SETTING_RANDOM_TEXT_MIN, "The minimum number of random characters to generate.", SETTINGS_DEFAULT_RANDOM_TEXT_MIN.ToString(), false, false);
                Core.Settings.updateOrAdd(PluginID, SETTING_RANDOM_TEXT_MAX, "The maximum number of random characters to generate.", SETTINGS_DEFAULT_RANDOM_TEXT_MIN.ToString(), false, false);
                Core.Settings.updateOrAdd(PluginID, SETTINGS_WIDTH, "The width of the captcha image.", SETTINGS_DEFAULT_WIDTH.ToString(), false, false);
                Core.Settings.updateOrAdd(PluginID, SETTINGS_HEIGHT, "The height of the captcha image.", SETTINGS_DEFAULT_HEIGHT.ToString(), false, false);
                Core.Settings.updateOrAdd(PluginID, SETTINGS_FONT_SIZE_MIN, "The minimum font-size of the captcha text.", SETTINGS_DEFAULT_FONT_SIZE_MIN.ToString(), false, false);
                Core.Settings.updateOrAdd(PluginID, SETTINGS_FONT_SIZE_MAX, "The maximum font-size of the captcha text.", SETTINGS_DEFAULT_FONT_SIZE_MAX.ToString(), false, false);
